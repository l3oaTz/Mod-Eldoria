...
public class ArrowTrail {
	...
	public void renderNodes(EntityArrow entity, float partialTicks) {
        ...
        for(int i = 1; i < MAX_LENGTH; i++) {
			...
			vertexbuffer.pos(pos0.x + (-right0.x)*scale0, pos0.y + (-right0.y)*scale0, pos0.z + (-right0.z)*scale0).tex(0.0D, 0.15625D).endVertex();
			vertexbuffer.pos(pos0.x + (right0.x)*scale0, pos0.y + (right0.y)*scale0, pos0.z + (right0.z)*scale0).tex(0.0D, 0.15625D).endVertex();
			vertexbuffer.pos(pos1.x + (right1.x)*scale1, pos1.y + (right1.y)*scale1, pos1.z + (right1.z)*scale1).tex(0.0D, 0.15625D).endVertex();
			vertexbuffer.pos(pos1.x + (-right1.x)*scale1, pos1.y + (-right1.y)*scale1, pos1.z + (-right1.z)*scale1).tex(0.0D, 0.15625D).endVertex();
			
			vertexbuffer.pos(pos0.x + (-up0.x)*scale0, pos0.y + (-up0.y)*scale0, pos0.z + (-up0.z)*scale0).tex(0.0D, 0.15625D).endVertex();
			vertexbuffer.pos(pos0.x + (up0.x)*scale0, pos0.y + (up0.y)*scale0, pos0.z + (up0.z)*scale0).tex(0.0D, 0.15625D).endVertex();
			vertexbuffer.pos(pos1.x + (up1.x)*scale1, pos1.y + (up1.y)*scale1, pos1.z + (up1.z)*scale1).tex(0.0D, 0.15625D).endVertex();
			vertexbuffer.pos(pos1.x + (-up1.x)*scale1, pos1.y + (-up1.y)*scale1, pos1.z + (-up1.z)*scale1).tex(0.0D, 0.15625D).endVertex();
		}
        tessellator.draw();
