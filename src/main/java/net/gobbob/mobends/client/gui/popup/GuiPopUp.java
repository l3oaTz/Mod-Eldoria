...
public class GuiPopUp {
	...
	public void display(int mouseX, int mouseY, float partialTicks) {
		...
		/* Top-Left		*/ Draw.texturedModalRect(x-4, y-4, 60, 64, 4, 4);
		/* Top 			*/ Draw.texturedModalRect(x, y-4, width, 4, 64, 64, 1, 4);
		/* Top-Right 	*/ Draw.texturedModalRect(x+width, y-4, 65, 64, 4, 4);
		/* Right 		*/ Draw.texturedModalRect(x+width, y, 4, height, 65, 68, 4, 1);
		/* Bottom-Right */ Draw.texturedModalRect(x+width, y+height, 65, 69, 4, 4);
		/* Bottom		*/ Draw.texturedModalRect(x, y+height, width, 4, 64, 69, 1, 4);
		/* Bottom-Left	*/ Draw.texturedModalRect(x-4, y+height, 60, 69, 4, 4);
		/* Left 		*/ Draw.texturedModalRect(x-4, y, 4, height, 60, 68, 4, 1);
		/* Inside		*/ Draw.texturedModalRect(x, y, width, height, 64, 68, 1, 1);
		int yOffset = 0;
